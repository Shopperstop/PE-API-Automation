...
public class callAPISSL implements Callable<JSONObject> {
	...
	public callAPISSL(JSONObject jsonstring, String mode, String key, String url, String clientId, String inputValue, String evValue, String scopeValue, String outputValue, String compmbValue, String indexValue) {
		super();
...
//			HttpsURLConnection httpCon = (HttpsURLConnection) url.openConnection();
			...
			httpCon.setRequestProperty("compmb-value", compmbValue);
			httpCon.setRequestProperty("index-value", indexValue);
...
//			jsonObject = gson.fromJson(result, JSONObject.class);
				...
				logger.info("Error records :"+httpCon.getResponseCode() + " :: " +httpCon.getResponseMessage() +" :: "+ jsonstring.toJSONString());
			}
		} catch (Exception e) {
