...
public class ResponseService {
	...
	/**
	 * Construct the Response service with the base api url of given app name configured in the testmode property.<br />
	 * Possible app-name : webapp, wms
	 * @see {@link APIUtility#getBaseURL(String)}
	 * @param app
	 */
	public ResponseService(String app) {
		//baseURL = APIUtility.getBaseURL(app); 
		baseURL = "";
	}
	 ...
	 * @param queryParam : look at {@link RequestSpecification#queryParameters(Map)}
...
//			Reporter.log("Response of " +stackTraceElements[3].getMethodName()+" :",true);
//			Reporter.log(res.asString(),true);
	...
	public Response getResponse(String url, String jsonBody, Map<String, ? extends Object> queryParam,
		...
		return getResponse( url,  jsonBody, queryParam,
				 contentType, headers,  methodType,true);
